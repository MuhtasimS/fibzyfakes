const commands = [
    ...
    {
        name: "remember",
        description: "Adds a piece of information to the bot's self-context memory.",
        options: [
            {
                name: "information",
                description: "The piece of information you want the bot to remember about itself.",
                type: 3, // String type
                required: true
            }
        ]
